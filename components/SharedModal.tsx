...
import { getImageSource, getImageSourceLarge } from "../utils/imageConfig";
...
export default function SharedModal({
  ...
  return (
    ...
    >
      <div
        className="relative z-50 flex h-full w-full max-w-7xl items-center justify-center p-4"
        {...handlers}
      >
        {/* Main image */}
